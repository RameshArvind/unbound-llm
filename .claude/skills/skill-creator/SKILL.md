...
## Creating Utility Skills for Recurring Tasks ⭐ IMPORTANT

**Don't solve the same problem twice.**

When a user comes with a task, ask yourself:
- ❓ Could this be asked again with different parameters?
- ❓ Is the core logic reusable?
- ❓ Can I parameterize it (different URL, file, input)?

**If YES → Create a utility skill!**
...
1. Write a parameterized Python script
2. Create `wikipedia-utils` skill
3. Next time someone asks about *any* Wikipedia page → use the skill!

**Second request:**
```
User: "How many references on Sheikh Hasina page?"
...
- Pattern will recur (different Wikipedia pages, different files, etc.)
...
See **[utility-skills-guide.md](references/utility-skills-guide.md)** for complete guide including:
- When to create utility skills
- Common patterns (web scraping, data extraction, API clients)
- Step-by-step example (Wikipedia reference counter)
- Script design principles
- Parameterization strategies
- Real working example: `.claude/skills/wikipedia-utils/`

**Key patterns:**
- Web data extraction (scraping, APIs)
- File format conversion (CSV, JSON, YAML)
- Text analysis (word count, sentiment, keywords)
- Data processing (filtering, aggregation, transformation)
- API integrations (GitHub, Slack, etc.)

### Example: Complete Utility Skill

See `.claude/skills/wikipedia-utils/` for a fully implemented example:
- Parameterized scripts (take URL as input)
- Reusable for any Wikipedia page
- Clear documentation
- Error handling
- Easy to extend
...
Same script, different parameters. **No rewriting!**
